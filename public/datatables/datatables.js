 ...
 *   https://datatables.net/download/#bs4-4.1.1/dt-1.10.20/af-2.3.4/b-1.6.1/fc-3.3.0/kt-2.5.1/r-2.2.3/rr-1.2.6/sc-2.0.1
 *
 * Included libraries:
 *   Bootstrap 4 4.1.1, DataTables 1.10.20, AutoFill 2.3.4, Buttons 1.6.1, FixedColumns 3.3.0, KeyTable 2.5.1, Responsive 2.2.3, RowReorder 1.2.6, Scroller 2.0.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		 ...
		 *          head.getElementsByTagName('th')[0].innerHTML = "Mostrando "+(end-start)+" registros";
		 *        }
		 *      } );
		 *    } )
		 */
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoFiltered": " - Filtrado de from _MAX_ de registros"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "processing": "El sistema esta procensado..."
			 *        }
			 *      } );
			 *    } );
			 */
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4-4.1.1/dt-1.10.20/af-2.3.4/b-1.6.1/fc-3.3.0/kt-2.5.1/r-2.2.3/rr-1.2.6/sc-2.0.1",
		 ...
		 *
		 * 1. `{int} pagina` The current page index
		 * 2. `{int} páginas` The number of pages in the table
		 *
		 * Each function is expected to return an array where each element of the
		 * array can be one of:
		 *
		 * * `primera` - Jump to first page when activated
		 * * `última` - Jump to last page when activated
		 * * `anterior` - Show previous page when activated
		 * * `siguiente` - Show next page when activated
